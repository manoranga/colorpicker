...
import com.example.colorpickerlibs.managers.CPCustomColorPalette;
...
import com.example.colorpickerlibs.utils.common.MyDevice;
...
import com.example.colorpickerlibs.utils.interfaces.EditTextChangeListener;
...
public class CPListRecyclerAdapter extends RecyclerView.Adapter<CPListRecyclerAdapter.ViewHolder> {
    ...
    public CPListRecyclerAdapter(Context context, boolean isTab, int rvWidth, int rvHeight, int currentColor, boolean isHidePinButton, KeyboardDismissListener keyboardDismissListener) {
    ...
    public void setMinimizeVersion(boolean isMinimizeVersion) {
