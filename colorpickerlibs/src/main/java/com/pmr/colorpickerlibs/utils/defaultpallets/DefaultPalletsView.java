package com.pmr.colorpickerlibs.utils.defaultpallets;
...
import com.pmr.colorpickerlibs.adapters.CPListRecyclerAdapter;
import com.pmr.colorpickerlibs.adapters.CPRecyclerAdapter;
import com.pmr.colorpickerlibs.databinding.DefaultPalletsViewBinding;
import com.pmr.colorpickerlibs.dialogs.CustomAlertDialog;
...
public class DefaultPalletsView extends FrameLayout {
    ...
    private void initView4() {
        ...
        cpListRecyclerAdapterTab = new CPListRecyclerAdapter(getContext(), true, rvWidth, rvHeight, currentSelectedColor, false, false, () -> {
        });
